...
import { readFollowingHead, readForFollowingPage } from "@/app/actions/feed";
...
export default function FollowingFeed({ isAuthenticated }: FollowingFeedProps) {
  ...
  const infiniteQueryKey = feedQueryKeys.FollowingInfinite(resetVersion);
  const headQueryKey = feedQueryKeys.FollowingHead(resetVersion);
  ...
  const feedQuery = useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) => readForFollowingPage(pageParam),
