...
- Le champ \`reasons\` doit contenir du texte libre court, neutre, factuel et utile. Pas de codes stables.
- Si \`moderationStatus = SAFE\`, retourne \`reasons: []\`.
- Si \`moderationStatus = UNCERTAIN\` ou \`UNSAFE\`, retourne entre 1 et 5 raisons courtes.
- La langue des éléments de \`reasons\` doit suivre la valeur fournie dans le champ \`language\`. Si \`language\` est absent, vide ou ambigu, utilise l'anglais.
